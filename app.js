...
function iodStepsFor(){ return isIsaFlow() ? ISA_STEPS : IOD_STEPS; }   // 공유 계좌인증 화면 스텝 라벨(ISA면 ISA_STEPS)
...
function renderIsaIntro(){
  return `<div class="fv-wrap">
    ...
    <div class="fv-card"><div class="fv-list">
      <div class="fv-item"><div class="fv-it"><div class="fv-nm">1. 신청현황 조회</div><div class="fv-sub">신규가입·계좌이전·만기연장 신청내역을 확인해요</div></div></div>
      <div class="fv-item"><div class="fv-it"><div class="fv-nm">2. 가입서류 제출</div><div class="fv-sub">서류 제출 또는 온라인 발급번호 입력으로 처리해요</div></div></div>
    </div></div>
